...
variable "vpc_cidr_block" {
  type        = string
  description = "Base CIDR Block for VPC(default = 172.16.0.0/16)"
}

variable "vpc_cidr_block_for_public1" {
  type        = string
  description = "Base CIDR Block for VPC(default = 172.16.1.0/24)"
}

variable "vpc_cidr_block_for_public2" {
  type        = string
  description = "Base CIDR Block for VPC(default = 172.16.3.0/24)"
}

variable "vpc_cidr_block_for_private1" {
  type        = string
  description = "Base CIDR Block for VPC (default = 172.16.4.0/24)"
}

variable "vpc_cidr_block_for_private2" {
  type        = string
  description = "Base CIDR Block for VPC (default = 172.16.5.0/24)"
}
